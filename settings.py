...
USE_S3 = True  # Mettez cela à True si vous voulez utiliser S3 pour le stockage des fichiers
...
MEDIA_URL = f'https://{AWS_STORAGE_BUCKET_NAME}.{AWS_S3_ENDPOINT_URL}/{AWS_LOCATION}/avatars/'
